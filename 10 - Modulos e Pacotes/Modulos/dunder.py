...
o Python atribuirá à variável __name__ o valor __main__ indicando que este módulo é o módulo de execusão principal

"""

from Modulos.teste_dunder import funcao
